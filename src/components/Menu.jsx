...
const Menu = () => {
  return (
    <div className="flex flex-col items-center mt-24 lg:mt-72 max-w-[1500px] m-auto">
      <div>
        <h1 className="mb-14">
          <span className="nav-logo text-[#EF5A34] text-6xl">Specialties</span>{" "}
          <br />
      ...
      <div className="container mx-auto hero-description lg:w-[1200px] px-4 lf">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4">
          ...
          <div className="border border-gray-300 h-60 order-8 md:order-7">
            <div className="m-4 flex flex-row justify-between text-xl font-bold text-[#23212B]">
              <h2 className="lg:w-52 leading-8">
                Pasta with spices and shrimp
              </h2>
          ...
          <div className="border border-gray-300 h-60 order-10 md:order-10">
            <div className="m-4 flex flex-row justify-between text-xl font-bold text-[#23212B]">
              <h2 className="lg:w-52 leading-8">
                Pasta with spices and shrimp
              </h2>
          ...
          <div className="border border-gray-300 h-60 order-12 md:order-12">
            <div className="m-4 flex flex-row justify-between text-xl font-bold text-[#23212B]">
              <h2 className="lg:w-52 leading-8">
                Pasta with spices and shrimp
              </h2>
