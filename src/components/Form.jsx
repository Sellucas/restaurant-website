        ...
        <Fade bottom distance='10%'>
          <div>
            <h1 className="mb-14 text-center">
              <span className="nav-logo text-[#EF5A34] text-6xl">Book a Table</span>{" "}
              <br />
              <span className="hero-title text-3xl text-[#23212B]">Make Reservation</span>
            </h1>
          </div>
          ...
          <form className="grid grid-cols-1 lg:grid-cols-2 gap-4 w-full">
            ...
            <div className="flex flex-col">
              <label htmlFor="date" className="lg:text-xl">
                Date:
              </label>
              <input type="date" id="date" name="date" className="border p-2" />
            </div>
            <div className="flex flex-col">
              <label htmlFor="time" className="lg:text-xl">
                Time:
              </label>
              <input type="time" id="time" name="time" className="border p-2" />
            </div>
            <div className="flex flex-col">
              <label htmlFor="person" className="lg:text-xl">
                Person:
              </label>
              <input
                type="number"
